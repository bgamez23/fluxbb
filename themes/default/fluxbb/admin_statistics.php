...
<?php if ($pun_user['g_id'] == PUN_ADMIN): ?>					<dt><?php echo $lang_admin_index['Environment label'] ?></dt>
					<dd>
						...
						<?php printf($lang_admin_index['Environment data version'], phpversion(), '<a href="?module=fluxbb&action=admin_statistics&act=phpinfo">'.$lang_admin_index['Show info'].'</a>') ?><br />
