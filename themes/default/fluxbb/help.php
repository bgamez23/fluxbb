...
<div class="box">
	<div class="inbox">
		...
		<p><code>[url]http://google.com[/url]</code> <?php echo $lang_help['produces'] ?> <samp><a href="http://google.com">http://google.com</a></samp></p>
		<p><code>[url=http://google.com]Google![/url]</code> <?php echo $lang_help['produces'] ?> <samp><a href="google.com">Google!</a></samp></p>
		...
		<p><code>[topic=1]<?php echo $lang_help['Test topic'] ?>[/topic]</code> <?php echo $lang_help['produces'] ?> <samp><a href="<?php echo pun_htmlspecialchars(get_base_url(true).'&action=viewtopic&id=1') ?>"><?php echo $lang_help['Test topic'] ?></a></samp></p>
		<p><code>[topic]1[/topic]</code> <?php echo $lang_help['produces'] ?> <samp><a href="<?php echo pun_htmlspecialchars(get_base_url(true).'&action=viewtopic&id=1') ?>"><?php echo pun_htmlspecialchars(get_base_url(true).'&action=viewtopic&id=1') ?></a></samp></p>
		<p><code>[post=1]<?php echo $lang_help['Test post'] ?>[/post]</code> <?php echo $lang_help['produces'] ?> <samp><a href="<?php echo pun_htmlspecialchars(get_base_url(true).'&action=viewtopic&pid=1#p1') ?>"><?php echo $lang_help['Test post'] ?></a></samp></p>
		<p><code>[post]1[/post]</code> <?php echo $lang_help['produces'] ?> <samp><a href="<?php echo pun_htmlspecialchars(get_base_url(true).'&action=viewtopic&pid=1#p1') ?>"><?php echo pun_htmlspecialchars(get_base_url(true).'&action=viewtopic&pid=1#p1') ?></a></samp></p>
		<p><code>[forum=1]<?php echo $lang_help['Test forum'] ?>[/forum]</code> <?php echo $lang_help['produces'] ?> <samp><a href="<?php echo pun_htmlspecialchars(get_base_url(true).'&action=viewforum&id=1') ?>"><?php echo $lang_help['Test forum'] ?></a></samp></p>
		<p><code>[forum]1[/forum]</code> <?php echo $lang_help['produces'] ?> <samp><a href="<?php echo pun_htmlspecialchars(get_base_url(true).'&action=viewforum&id=1') ?>"><?php echo pun_htmlspecialchars(get_base_url(true).'&action=viewforum&id=1') ?></a></samp></p>
		<p><code>[user=2]<?php echo $lang_help['Test user'] ?>[/user]</code> <?php echo $lang_help['produces'] ?> <samp><a href="<?php echo pun_htmlspecialchars(get_base_url(true).'&action=profile&id=2') ?>"><?php echo $lang_help['Test user'] ?></a></samp></p>
		<p><code>[user]2[/user]</code> <?php echo $lang_help['produces'] ?> <samp><a href="<?php echo pun_htmlspecialchars(get_base_url(true).'&action=profile&id=2') ?>"><?php echo pun_htmlspecialchars(get_base_url(true).'&action=profile&id=2') ?></a></samp></p>
	</div>
	<div class="inbox">
		<p><a name="img"></a><?php echo $lang_help['Images info'] ?></p>
		<p><code>[img=<?php echo $lang_help['FluxBB bbcode test'] ?>]<?php echo str_replace('?module=', '', pun_htmlspecialchars(get_base_url(true))) ?>/img/test.png[/img]</code> <?php echo $lang_help['produces'] ?> <samp><img style="height: 21px" src="<?php echo str_replace('?module=', '', pun_htmlspecialchars(get_base_url(true))) ?>/img/test.png" alt="<?php echo $lang_help['FluxBB bbcode test'] ?>" /></samp></p>
	</div>
</div>
