...
$paging_links = '<span class="pages-label">'.$lang_common['Pages'].' </span>'.paginate($num_pages, $p, '?module=fluxbb&action=userlist&username='.urlencode($username).'&amp;show_group='.$show_group.'&amp;sort_by='.$sort_by.'&amp;sort_dir='.$sort_dir);
...
<div id="users1">
	...
	<div class="box blocktable">
		<div class="inbox">
			<table cellspacing="0">
			<thead>
				<tr>
					<th class="tc2" scope="col"><?php echo $lang_common['Username'] ?></th>
