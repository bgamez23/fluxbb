...
if (!file_exists('fluxbb/config.php')) {
	header('Location: ?module=fluxbb&act=install');
}
...
<div class="blockform">
	...
	<div class="box">
		<form id="upload_avatar" method="post" enctype="multipart/form-data" action="?module=fluxbb&action=profile&act=upload_avatar2&amp;id=<?php echo $id ?>" onsubmit="return process_form(this)">
			<div class="inform">
				<fieldset>
...
<div class="blockform">
	...
	<div class="box">
		<form id="confirm_del_user" method="post" action="?module=fluxbb&action=profile&id=<?php echo $id ?>">
			<div class="inform">
				<fieldset>
	...
	$user['g_moderator'] == '1'))))																// or the user is another mod
{
	...
	if ($user['email_setting'] == '0' && !$pun_user['is_guest'] && $pun_user['g_send_email'] == '1')
		...
		$email_field = '<a href="?module=fluxbb&action=misc&email='.$id.'">'.$lang_common['Send email'].'</a>';
	else
		$email_field = '';
	if ($email_field != '')
	{
	...
	if ($pun_user['g_search'] == '1')
	{
		...
		if ($user['num_posts'] > 0)
		{
			$quick_searches[] = '<a href="?module=fluxbb&action=search&act=show_user_topics&amp;user_id='.$id.'">'.$lang_profile['Show topics'].'</a>';
			$quick_searches[] = '<a href="?module=fluxbb&action=search&act=show_user_posts&amp;user_id='.$id.'">'.$lang_profile['Show posts'].'</a>';
		}
		if ($pun_user['is_admmod'] && $pun_config['o_topic_subscriptions'] == '1')
			$quick_searches[] = '<a href="?module=fluxbb&action=search&act=show_subscriptions&amp;user_id='.$id.'">'.$lang_profile['Show subscriptions'].'</a>';
...
else
{
	if (!$section || $section == 'essentials')
	{
		if ($pun_user['is_admmod'])
		{
			...
			// else
				$username_field = '<p>'.pun_htmlspecialchars($user['username']).'</p>'."\n";

			$email_field = '<label class="required"><strong>'.$lang_common['Email'].' <span>'.$lang_common['Required'].'</span></strong><br /><input type="text" name="req_email" value="'.$user['email'].'" size="40" maxlength="80" /><br /></label><p><span class="email"><a href="?module=fluxbb&action=misc&email='.$id.'">'.$lang_common['Send email'].'</a></span></p>'."\n";
		}
		else
		{
			$username_field = '<p>'.pun_htmlspecialchars($user['username']).'</p>'."\n";
			...
			if ($pun_config['o_regs_verify'] == '1')
				$email_field = '<p>'.sprintf($lang_profile['Email info'], $user['email'].' - <a href="?module=fluxbb&action=profile&act=change_email&amp;id='.$id.'">'.$lang_profile['Change email'].'</a>').'</p>'."\n";
			else
		...
		{
			$posts_actions[] = '<a href="?module=fluxbb&action=search&act=show_user_topics&amp;user_id='.$id.'">'.$lang_profile['Show topics'].'</a>';
			$posts_actions[] = '<a href="?module=fluxbb&action=search&act=show_user_posts&amp;user_id='.$id.'">'.$lang_profile['Show posts'].'</a>';

			if ($pun_config['o_topic_subscriptions'] == '1')
				$posts_actions[] = '<a href="?module=fluxbb&action=search&act=show_subscriptions&amp;user_id='.$id.'">'.$lang_profile['Show subscriptions'].'</a>';
		}
...
<div id="profile" class="block2col">
	<div class="blockmenu">
		...
		<div class="box">
			<div class="inbox">
				<ul>
					<li<?php if ($page == 'essentials') echo ' class="isactive"'; ?>><a href="?module=fluxbb&action=profile&section=essentials&amp;id=<?php echo $id ?>"><?php echo $lang_profile['Section essentials'] ?></a></li>
					<li<?php if ($page == 'personal') echo ' class="isactive"'; ?>><a href="?module=fluxbb&action=profile&section=personal&amp;id=<?php echo $id ?>"><?php echo $lang_profile['Section personal'] ?></a></li>
					<li<?php if ($page == 'messaging') echo ' class="isactive"'; ?>><a href="?module=fluxbb&action=profile&section=messaging&amp;id=<?php echo $id ?>"><?php echo $lang_profile['Section messaging'] ?></a></li>
<?php if ($pun_config['o_avatars'] == '1' || $pun_config['o_signatures'] == '1'): ?>					<li<?php if ($page == 'personality') echo ' class="isactive"'; ?>><a href="?module=fluxbb&action=profile&section=personality&amp;id=<?php echo $id ?>"><?php echo $lang_profile['Section personality'] ?></a></li>
<?php endif; ?>					<li<?php if ($page == 'display') echo ' class="isactive"'; ?>><a href="?module=fluxbb&action=profile&section=display&amp;id=<?php echo $id ?>"><?php echo $lang_profile['Section display'] ?></a></li>
					<li<?php if ($page == 'privacy') echo ' class="isactive"'; ?>><a href="?module=fluxbb&action=profile&section=privacy&amp;id=<?php echo $id ?>"><?php echo $lang_profile['Section privacy'] ?></a></li>
<?php if ($pun_user['g_id'] == PUN_ADMIN || ($pun_user['g_moderator'] == '1' && $pun_user['g_mod_ban_users'] == '1')): ?>					<li<?php if ($page == 'admin') echo ' class="isactive"'; ?>><a href="?module=fluxbb&action=profile&section=admin&amp;id=<?php echo $id ?>"><?php echo $lang_profile['Section admin'] ?></a></li>
<?php endif; ?>				</ul>
			</div>
		</div>
	</div>
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="profile1" method="post" action="?module=fluxbb&action=profile&section=essentials&amp;id=<?php echo $id ?>" onsubmit="return process_form(this)">
				<div class="inform">
					<fieldset>
				...
				<div class="inform">
					<fieldset>
						<legend><?php echo $lang_common['Email'] ?></legend>
						<div class="infldset">
							<p class="clearb actions">
								<?php echo $user['email'] ?> <span><a href="?module=account&action=changemail"><?php echo $lang_profile['Change email'] ?></a></span>
							</p>
						</div>
					</fieldset>
				</div>
...
?>
				...
				<div class="inform">
					<fieldset>
						<legend><?php echo $lang_profile['User activity'] ?></legend>
						<div class="infldset">
							<p><?php printf($lang_profile['Registered info'], format_time($user['registered'], true).(($pun_user['is_admmod']) ? ' (<a href="?module=fluxbb&action=moderate&get_host='.pun_htmlspecialchars($user['registration_ip']).'">'.pun_htmlspecialchars($user['registration_ip']).'</a>)' : '')) ?></p>
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="profile2" method="post" action="?module=fluxbb&action=profile&section=personal&amp;id=<?php echo $id ?>">
				<div class="inform">
					<fieldset>
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="profile3" method="post" action="?module=fluxbb&action=profile&section=messaging&amp;id=<?php echo $id ?>">
				<div class="inform">
					<fieldset>
...
<?php
	...
	else if ($section == 'personality')
	{
		...
		$avatar_field = '<span><a href="?module=fluxbb&action=profile&act=upload_avatar&amp;id='.$id.'">'.$lang_profile['Change avatar'].'</a></span>';

		$user_avatar = generate_avatar_markup($id);
		if ($user_avatar)
			$avatar_field .= ' <span><a href="?module=fluxbb&action=profile&act=delete_avatar&amp;id='.$id.'">'.$lang_profile['Delete avatar'].'</a></span>';
		else
			$avatar_field = '<span><a href="?module=fluxbb&action=profile&act=upload_avatar&amp;id='.$id.'">'.$lang_profile['Upload avatar'].'</a></span>';
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="profile4" method="post" action="?module=fluxbb&action=profile&section=personality&amp;id=<?php echo $id ?>">
...
<?php endif; if ($pun_config['o_signatures'] == '1'): ?>				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							...
							<ul class="bblinks">
								<li><span><a href="?module=fluxbb&action=help#bbcode" onclick="window.open(this.href); return false;"><?php echo $lang_common['BBCode'] ?></a> <?php echo ($pun_config['p_sig_bbcode'] == '1') ? $lang_common['on'] : $lang_common['off']; ?></span></li>
								<li><span><a href="?module=fluxbb&action=help#url" onclick="window.open(this.href); return false;"><?php echo $lang_common['url tag'] ?></a> <?php echo ($pun_config['p_sig_bbcode'] == '1' && $pun_user['g_post_links'] == '1') ? $lang_common['on'] : $lang_common['off']; ?></span></li>
								<li><span><a href="?module=fluxbb&action=help#img" onclick="window.open(this.href); return false;"><?php echo $lang_common['img tag'] ?></a> <?php echo ($pun_config['p_sig_bbcode'] == '1' && $pun_config['p_sig_img_tag'] == '1') ? $lang_common['on'] : $lang_common['off']; ?></span></li>
								<li><span><a href="?module=fluxbb&action=help#smilies" onclick="window.open(this.href); return false;"><?php echo $lang_common['Smilies'] ?></a> <?php echo ($pun_config['o_smilies_sig'] == '1') ? $lang_common['on'] : $lang_common['off']; ?></span></li>
							</ul>
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="profile5" method="post" action="?module=fluxbb&action=profile&section=display&amp;id=<?php echo $id ?>">
				<div><input type="hidden" name="form_sent" value="1" /></div>
<?php
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="profile6" method="post" action="?module=fluxbb&action=profile&section=privacy&amp;id=<?php echo $id ?>">
				<div class="inform">
					<fieldset>
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="profile7" method="post" action="?module=fluxbb&action=profile&section=admin&amp;id=<?php echo $id ?>">
				<div class="inform">
				<input type="hidden" name="form_sent" value="1" />
					<fieldset>
<?php
