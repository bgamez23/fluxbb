...
{
	if ($is_admmod)
		confirm_referrer('&action=delete');
...
<div class="linkst">
	<div class="inbox">
		<ul class="crumbs">
			...
			<li><span>»&#160;</span><a href="?module=fluxbb&action=viewtopic&pid=<?php echo $id ?>#p<?php echo $id ?>"><?php echo pun_htmlspecialchars($cur_post['subject']) ?></a></li>
...
<div class="blockform">
	...
	<div class="box">
		<form method="post" action="?module=fluxbb&action=delete&id=<?php echo $id ?>">
			<div class="inform">
				<div class="forminfo">
