...
{
	confirm_referrer('?module=fluxbb&action=admin_forums');
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form method="post" action="?module=fluxbb&action=admin_forums&del_forum=<?php echo $forum_id ?>">
				<div class="inform">
					<fieldset>
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="edit_forum" method="post" action="?module=fluxbb&action=admin_forums&edit_forum=<?php echo $forum_id ?>">
...
?>
				...
				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							<p><?php printf($lang_admin_forums['Group permissions info'], '<a href="?module=fluxbb&action=admin_groups">'.$lang_admin_common['User groups'].'</a>') ?></p>
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form method="post" action="?module=fluxbb&action=admin_forums&act=adddel">
				<div class="inform">
					<fieldset>
...
?>
		...
		<div class="box">
			<form id="edforum" method="post" action="?module=fluxbb&action=admin_forums&act=edit">
...
?>
								<tr>
									<td class="tcl"><a href="?module=fluxbb&action=admin_forums&edit_forum=<?php echo $cur_forum['fid'] ?>" tabindex="<?php echo $cur_index++ ?>"><?php echo $lang_admin_forums['Edit link'] ?></a> | <a href="?module=fluxbb&action=admin_forums&del_forum=<?php echo $cur_forum['fid'] ?>" tabindex="<?php echo $cur_index++ ?>"><?php echo $lang_admin_forums['Delete link'] ?></a></td>
