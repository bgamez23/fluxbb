...
{
	confirm_referrer('?module=fluxbb&action=admin_options', $lang_admin_options['Bad HTTP Referer message']);
	...
	redirect('?module=fluxbb&action=admin_options', $lang_admin_options['Options updated redirect']);
}
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form method="post" action="?module=fluxbb&action=admin_options">
							...
							<table class="aligntop" cellspacing="0">
								...
								<tr>
									...
									<td>
										...
										<span class="clearb"><?php printf($lang_admin_options['Censor words help'], '<a href="?module=fluxbb&action=admin_censoring">'.$lang_admin_common['Censoring'].'</a>') ?></span>
									</td>
								</tr>
								<tr>
