...
{
	confirm_referrer('?module=fluxbb&action=admin_permissions');
	...
	redirect('?module=fluxbb&action=admin_permissions', $lang_admin_permissions['Perms updated redirect']);
}
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form method="post" action="?module=fluxbb&action=admin_permissions">
