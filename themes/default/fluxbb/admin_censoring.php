...
{
	confirm_referrer('?module=fluxbb&action=admin_censoring');
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="censoring" method="post" action="?module=fluxbb&action=admin_censoring">
				<div class="inform">
					<fieldset>
						<legend><?php echo $lang_admin_censoring['Add word subhead'] ?></legend>
						<div class="infldset">
							<p><?php echo $lang_admin_censoring['Add word info'].' '.($pun_config['o_censoring'] == '1' ? sprintf($lang_admin_censoring['Censoring enabled'], '<a href="?module=fluxbb&action=admin_options#censoring">'.$lang_admin_common['Options'].'</a>') : sprintf($lang_admin_censoring['Censoring disabled'], '<a href="?module=fluxbb&action=admin_options#censoring">'.$lang_admin_common['Options'].'</a>')) ?></p>
							<table cellspacing="0">
							<thead>
								<tr>
