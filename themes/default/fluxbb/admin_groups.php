...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="groups2" method="post" action="?module=fluxbb&action=admin_groups" onsubmit="return process_form(this)">
...
{
	confirm_referrer('?module=fluxbb&action=admin_groups');
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form method="post" action="?module=fluxbb&action=admin_groups&del_group=<?php echo $group_id ?>">
				<div class="inform">
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="groups" method="post" action="?module=fluxbb&action=admin_groups&del_group=<?php echo $group_id ?>">
				<div class="inform">
					<fieldset>
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form id="groups" method="post" action="?module=fluxbb&action=admin_groups">
				<div class="inform">
					<fieldset>
...
foreach ($groups as $cur_group)
	echo "\t\t\t\t\t\t\t\t".'<tr><th scope="row"><a href="?module=fluxbb&action=admin_groups&edit_group='.$cur_group['g_id'].'" tabindex="'.$cur_index++.'">'.$lang_admin_groups['Edit link'].'</a>'.(($cur_group['g_id'] > PUN_MEMBER) ? ' | <a href="?module=fluxbb&action=admin_groups&del_group='.$cur_group['g_id'].'" tabindex="'.$cur_index++.'">'.$lang_admin_groups['Delete link'].'</a>' : '').'</th><td>'.pun_htmlspecialchars($cur_group['g_title']).'</td></tr>'."\n";
