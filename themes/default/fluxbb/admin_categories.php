...
{
	confirm_referrer('&action=admin_categories');
...
?>
	<div class="blockform">
		...
		<div class="box">
			<form method="post" action="?module=fluxbb&action=admin_categories">
				<div class="inform">
							...
							<table class="aligntop" cellspacing="0">
								<tr>
									...
									<td>
										...
										<span><?php printf($lang_admin_categories['Add category help'], '<a href="?module=fluxbb&action=admin_forums">'.$lang_admin_common['Forums'].'</a>') ?></span>
									</td>
								</tr>
							</table>
						</div>
