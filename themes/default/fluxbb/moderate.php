...
if ($params->get('tid'))
{
	...
	if (isset($_POST['delete_posts']) || isset($_POST['delete_posts_comply']))
	{
		...
		if (isset($_POST['delete_posts_comply']))
		{
			...
			redirect('&action=viewtopic&id='.$tid, $lang_misc['Delete posts redirect']);
		}
...
<?php
	...
	else if (isset($_POST['split_posts']) || isset($_POST['split_posts_comply']))
	{
		...
		if (isset($_POST['split_posts_comply']))
		{
			...
			redirect('&action=viewtopic&id='.$new_tid, $lang_misc['Split posts redirect']);
		}
...
if (isset($_REQUEST['move_topics']) || isset($_POST['move_topics_to']))
{
	if (isset($_POST['move_topics_to']))
	{
		...
		redirect('&action=viewforum&id='.$move_to_forum, $redirect_msg);
	}
...
else if (isset($_POST['merge_topics']) || isset($_POST['merge_topics_comply']))
{
	if (isset($_POST['merge_topics_comply']))
	{
		...
		update_forum($fid);
		redirect('&action=viewforum&id='.$fid, $lang_misc['Merge topics redirect']);
	}
...
else if (isset($_POST['delete_topics']) || isset($_POST['delete_topics_comply']))
{
	...
	if (isset($_POST['delete_topics_comply']))
	{
		...
		redirect('&action=viewforum&id='.$fid, $lang_misc['Delete topics redirect']);
	}
...
else if (isset($_REQUEST['open']) || isset($_REQUEST['close']))
{
	...
	if (isset($_POST['open']) || isset($_POST['close']))
	{
		...
		redirect('&action=moderate&fid='.$fid, $redirect_msg);
	}
	// Or just one in $_GET
	else
	{
		...
		redirect('&action=viewtopic&id='.$topic_id, $redirect_msg);
	}
}
...
else if (isset($_GET['stick']))
{
	...
	redirect('&action=viewtopic&id='.$stick, $lang_misc['Stick topic redirect']);
}
...
else if (isset($_GET['unstick']))
{
	...
	redirect('&action=viewtopic&id='.$unstick, $lang_misc['Unstick topic redirect']);
}
