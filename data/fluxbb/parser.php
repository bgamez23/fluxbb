...
function do_bbcode($text, $is_signature = false)
{
	...
	$replace[] = 'handle_url_tag(\''.get_base_url(true).'&action=viewtopic&id=$1\')';
	$replace[] = 'handle_url_tag(\''.get_base_url(true).'&action=viewtopic&id=$1\', \'$2\')';
	$replace[] = 'handle_url_tag(\''.get_base_url(true).'&action=viewtopic&pid=$1#p$1\')';
	$replace[] = 'handle_url_tag(\''.get_base_url(true).'&action=viewtopic&pid=$1#p$1\', \'$2\')';
	$replace[] = 'handle_url_tag(\''.get_base_url(true).'&action=viewforum&id=$1\')';
	$replace[] = 'handle_url_tag(\''.get_base_url(true).'&action=viewforum&id=$1\', \'$2\')';
	$replace[] = 'handle_url_tag(\''.get_base_url(true).'&action=profile&id=$1\')';
	$replace[] = 'handle_url_tag(\''.get_base_url(true).'&action=profile&id=$1\', \'$2\')';
